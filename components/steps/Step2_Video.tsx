...
export const Step2_Video: React.FC<StepProps> = ({ data, updateData, onNext, onPrev }) => {
  ...
  const handleNext = () => {
    if (!data.step2_watched) {
      setError('РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РїРѕРґС‚РІРµСЂРґРёС‚Рµ РїСЂРѕСЃРјРѕС‚СЂ РІРёРґРµРѕ.');
      return;
    }
    
    // Check Control Question
    if (data.step2_control_answer !== APP_CONFIG.video.correctControlAnswer) {
      setError('РћС‚РІРµС‚ РЅР° РєРѕРЅС‚СЂРѕР»СЊРЅС‹Р№ РІРѕРїСЂРѕСЃ РЅРµРІРµСЂРµРЅ. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РїРѕСЃРјРѕС‚СЂРёС‚Рµ РІРёРґРµРѕ РІРЅРёРјР°С‚РµР»СЊРЅРµРµ.');
      return;
    }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="text-center md:text-left">
        ...
        <p className="text-[#404040]/70 text-lg">РџРѕСЃРјРѕС‚СЂРёС‚Рµ РєРѕСЂРѕС‚РєРѕРµ РІРёРґРµРѕ Рѕ РІР°РєР°РЅСЃРёРё, С‡С‚РѕР±С‹ РѕС‚РІРµС‚РёС‚СЊ РЅР° РїСЂРѕРІРµСЂРѕС‡РЅС‹Р№ РІРѕРїСЂРѕСЃ.</p>
      </div>
             ...
             {timeLeft > 0 ? (
               <div className="text-center">
                 <div className="animate-pulse bg-[#404040] p-6 rounded-2xl border border-white/10">
                    ...
                    <p className="text-white/60 font-medium">Р’РёРґРµРѕ РІРѕСЃРїСЂРѕРёР·РІРѕРґРёС‚СЃСЏ...</p>
               ...
               <div className="text-white text-lg font-bold bg-[#FF495C] px-8 py-4 rounded-full shadow-lg">
                 Р’РёРґРµРѕ РїСЂРѕСЃРјРѕС‚СЂРµРЅРѕ
               </div>
             )}
          </div>
        )}
        ...
        <div className="bg-[#FAFAFA] p-8 rounded-[2rem] border border-[#404040]/5 space-y-6">
          ...
          <div className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-[#404040]/5 shadow-sm">
            ...
            <label htmlFor="watched" className="text-[#404040] font-bold cursor-pointer text-lg">
              РЇ РїРѕР»РЅРѕСЃС‚СЊСЋ РїРѕСЃРјРѕС‚СЂРµР»(Р°) РІРёРґРµРѕ
            </label>
          </div>

          <div className="pt-4 border-t border-[#404040]/10">
            <label className="block text-lg font-bold text-[#404040] mb-4">
              РљРѕРЅС‚СЂРѕР»СЊРЅС‹Р№ РІРѕРїСЂРѕСЃ: <span className="text-[#FF495C]">{APP_CONFIG.video.controlQuestion}</span>
            </label>
      ...
      <div className="flex justify-between pt-6">
        <Button variant="outline" onClick={onPrev}>
          <ArrowLeft className="mr-2 w-5 h-5" /> РќР°Р·Р°Рґ
        </Button>
        <Button onClick={handleNext} disabled={!showControls}>
          Р”Р°Р»РµРµ <ArrowRight className="ml-2 w-5 h-5" />
        </Button>
      </div>
    </div>
  );
